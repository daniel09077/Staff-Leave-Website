...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>KADUNA POLYTECNIC STAFF LEAVE SYSTEM</title>

	<link rel="shortcut icon" href="vendors/images/logo.png" type="https://d1234abcd.cloudfront.net/image/x-icon">
	<!-- Site favicon 
	<link rel="apple-touch-icon" sizes="180x180" href="vendors/images/apple-touch-icon.png">
	<link rel="icon" type="https://d1234abcd.cloudfront.net/image/png" sizes="32x32" href="vendors/images/favicon-32x32.png">
	<link rel="icon" type="https://d1234abcd.cloudfront.net/image/png" sizes="16x16" href="vendors/images/favicon-16x16.png">-->
...
<body class="login-page">
	<div class="login-header box-shadow" id="hades">
		<div class="container-fluid d-flex justify-content-between align-items-center" >
			<div class="brand-logo">
				<a href="index.html">
					<img src="vendors/images/hea.png" alt="">
				</a>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="col-md-6 col-lg-5" >
					<div class="login-box bg-white box-shadow border-radius-10" id="loginbox">
						<div class="login-title">
							<h2 class="text-center text-primary">Welcome To the Leave Manager</h2>
						</div>
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group mb-0">
									 	  <input class="btn btn-primary btn-lg btn-block btn-" name="signin" id="signin" type="submit" value="Sign In">
									</div>
								</div>
							</div>
						</form>
